...
const ReviewForm = (): JSX.Element => {
  ...
  const handelReviewForm = (evt: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
  ...
  return(
    <form className="reviews__form form" action="#" method="post">
      ...
      <div className="reviews__rating-form form__rating">
        <input className="form__rating-input visually-hidden" name="rating" value="5" id="5-stars" type="radio" onChange={handelReviewForm}/>
      ...
      <textarea className="reviews__textarea form__textarea" id="review" name="review" placeholder="Tell how was your stay, what you like and what can be improved" onChange={handelReviewForm}></textarea>
